 ...
 */
var base = __webpack_require__(/*! ./methods/base */ "./src/methods/base.js");

var check = __webpack_require__(/*! ./methods/check */ "./src/methods/check.js");

var date = __webpack_require__(/*! ./methods/date */ "./src/methods/date.js");

var file = __webpack_require__(/*! ./methods/file */ "./src/methods/file.js");

var money = __webpack_require__(/*! ./methods/money */ "./src/methods/money.js");

var transform = __webpack_require__(/*! ./methods/transform */ "./src/methods/transform.js");

var storage = __webpack_require__(/*! ./methods/storage */ "./src/methods/storage.js");

var url = __webpack_require__(/*! ./methods/url */ "./src/methods/url.js"); // const xrkTools = function () {
//   this.base = base;
//   this.check = check;
//   this.date = date;
//   this.file = file;
...
var file = {
   ...
   * @param {String} base64
   */
  dataURLToBlob: function dataURLToBlob(base64) {
   ...
   * @param {Blob} blob
   */
  blobToDataURI: function blobToDataURI(blob) {
   ...
   */
  imgElement2Base64: function imgElement2Base64(imgElement) {
   ...
   */
  imgUrl2Base64: function imgUrl2Base64(imgUrl) {
    return new Promise(function (resolve) {
      var img = new Image();
   ...
   * @param {*} options
   */
  getNetFile: function getNetFile(url) {
    var responseType = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : "blob";
   ...
   * @param {any} content
   */
  contentToQrcodeUrl: function contentToQrcodeUrl(content) {
    var canvas = document.createElement("canvas");
    return new Promise(function (resolve) {
...
var url = {
   ...
   */
  queryFormat: function queryFormat(query) {
    if (!isObject(query)) {
    ...
    for (var key in query) {
      if (Object.hasOwnProperty.call(query, key)) {
        ...
        if (isNumber(value) || isString(value) || isBoolean(value)) {
          _dealQueryArr.push("".concat(key, "=").concat(value));
        }
      }
    }

    return "?".concat(_dealQueryArr.join("&"));
  }
};
module.exports = url;
